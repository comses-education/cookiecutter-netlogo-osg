...
MODEL_NAME={{ cookiecutter.model_slug }}  # replace with the name of your computational model. No spaces
MODEL_FILE={{ cookiecutter.model_file }}  # replace with your main NetLogo entrypoint file.
...
OSG_SUBMIT_FILENAME=${MODEL_NAME}.sub
